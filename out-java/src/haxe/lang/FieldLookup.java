...
public class FieldLookup extends haxe.lang.HxObject
{
	...
	public FieldLookup()
	{
		//line 28 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\FieldLookup.hx"
	...
	{
		//line 41 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\FieldLookup.hx"
		int min = 0;
		//line 42 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\FieldLookup.hx"
		int max = length;
		//line 44 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\FieldLookup.hx"
		while (( min < max ))
		{
			//line 46 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\FieldLookup.hx"
			int mid = ((int) (( (( max + min )) / 2 )) );
			//line 47 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\FieldLookup.hx"
			int classify = hash.compareTo(hashs[mid]);
			//line 48 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\FieldLookup.hx"
			if (( classify < 0 )) 
			{
				//line 50 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\FieldLookup.hx"
				max = mid;
			}
			else
			{
				//line 51 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\FieldLookup.hx"
				if (( classify > 0 )) 
				{
					//line 52 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\FieldLookup.hx"
					min = ( mid + 1 );
				}
				else
				{
					//line 54 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\FieldLookup.hx"
					return mid;
				}
		...
		//line 58 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\FieldLookup.hx"
		return  ~ (min) ;
	}
	...
	{
		//line 62 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\FieldLookup.hx"
		java.lang.System.arraycopy(((java.lang.Object) (a) ), ((int) (( pos + 1 )) ), ((java.lang.Object) (a) ), ((int) (pos) ), ((int) (( ( length - pos ) - 1 )) ));
		//line 63 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\FieldLookup.hx"
		a[( length - 1 )] = null;
	}
	...
	{
		//line 67 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\FieldLookup.hx"
		java.lang.System.arraycopy(((java.lang.Object) (a) ), ((int) (( pos + 1 )) ), ((java.lang.Object) (a) ), ((int) (pos) ), ((int) (( ( length - pos ) - 1 )) ));
		//line 68 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\FieldLookup.hx"
		a[( length - 1 )] = ((double) (0) );
	}
	...
	{
		//line 72 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\FieldLookup.hx"
		java.lang.System.arraycopy(((java.lang.Object) (a) ), ((int) (( pos + 1 )) ), ((java.lang.Object) (a) ), ((int) (pos) ), ((int) (( ( length - pos ) - 1 )) ));
		//line 73 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\FieldLookup.hx"
		a[( length - 1 )] = null;
	}
	...
	{
		//line 121 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\FieldLookup.hx"
		{
			//line 121 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\FieldLookup.hx"
	...
	{
		//line 122 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\FieldLookup.hx"
		{
			//line 122 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\FieldLookup.hx"
			double[] a1 = a;
			//line 122 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\FieldLookup.hx"
	...
	{
		//line 123 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\FieldLookup.hx"
		{
			//line 123 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\FieldLookup.hx"
