...
public class StringRefl
{
	static
	{
		//line 209 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
	...
	{
		//line 213 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
		{
			//line 213 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
			...
			switch (__temp_hash3)
			{
				case -1106363674:
				{
					...
					if (__temp_svar1.equals("length")) 
					{
						...
						//line 215 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
						return str.length();
					}
				...
				case -399551817:
				{
					...
					if (( (( ( __temp_hash3 == 530542161 ) && __temp_svar1.equals("substring") )) || ( (( ( __temp_hash3 == -891529231 ) && __temp_svar1.equals("substr") )) || ( (( ( __temp_hash3 == 109648666 ) && __temp_svar1.equals("split") )) || ( (( ( __temp_hash3 == -467511597 ) && __temp_svar1.equals("lastIndexOf") )) || ( (( ( __temp_hash3 == 1943291465 ) && __temp_svar1.equals("indexOf") )) || ( (( ( __temp_hash3 == 397153782 ) && __temp_svar1.equals("charCodeAt") )) || ( (( ( __temp_hash3 == -1361633751 ) && __temp_svar1.equals("charAt") )) || ( (( ( __temp_hash3 == -1137582698 ) && __temp_svar1.equals("toLowerCase") )) || __temp_svar1.equals("toUpperCase") ) ) ) ) ) ) ) )) 
					{
						//line 213 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
						__temp_executeDef2 = false;
						//line 217 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
			...
			//line 219 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
			if (__temp_executeDef2) 
			{
				//line 219 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
				if (throwErrors) 
				{
					//line 220 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
					throw haxe.lang.HaxeException.wrap(( ( "Field not found: \'" + f ) + "\' in String" ));
				}
				else
				{
					//line 222 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
					return null;
				}
	...
	{
		//line 228 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
		haxe.root.Array _args = new haxe.root.Array(new java.lang.Object[]{str});
		//line 229 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
		if (( args == null )) 
		{
			//line 230 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
			args = _args;
		}
		else
		{
			//line 232 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
			args = _args.concat(args);
		}
		
		//line 234 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\StringExt.hx"
