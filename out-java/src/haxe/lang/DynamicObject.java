...
public class DynamicObject extends haxe.lang.HxObject
{
	...
	{
		//line 43 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\HxObject.hx"
	...
	{
		//line 47 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\HxObject.hx"
		haxe.lang.Function ts = ((haxe.lang.Function) (haxe.lang.Runtime.getField(this, "toString", false)) );
		//line 48 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\HxObject.hx"
		if (( ts != null )) 
		{
			//line 49 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\HxObject.hx"
			return haxe.lang.Runtime.toString(ts.__hx_invoke0_o());
		}
		
		//line 50 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\HxObject.hx"
		haxe.root.StringBuf ret = new haxe.root.StringBuf();
		//line 51 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\HxObject.hx"
		ret.add("{");
		//line 52 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\HxObject.hx"
		boolean first = true;
		//line 53 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\HxObject.hx"
		{
			//line 53 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\HxObject.hx"
			int _g = 0;
			//line 53 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\HxObject.hx"
			...
			while (( _g < _g1.length ))
			{
				...
				//line 53 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\HxObject.hx"
				 ++ _g;
				//line 55 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\HxObject.hx"
				if (first) 
				{
					//line 56 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\HxObject.hx"
					first = false;
				}
				else
				{
					//line 58 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\HxObject.hx"
					ret.add(",");
				}
				
				//line 59 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\HxObject.hx"
				ret.add(" ");
				//line 59 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\HxObject.hx"
				ret.add(f);
				//line 60 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\HxObject.hx"
				ret.add(" : ");
				//line 61 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\HxObject.hx"
				ret.add(haxe.root.Reflect.field(this, f));
			}
			
		}
		
		//line 63 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\HxObject.hx"
		if ( ! (first) ) 
		{
			//line 63 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\HxObject.hx"
			ret.add(" ");
		...
		//line 64 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\HxObject.hx"
		ret.add("}");
		//line 65 "F:\\HaxeToolkit\\haxe\\std\\java\\internal\\HxObject.hx"
		return ret.toString();
	}
